...
complete -c go-modiff -n '__fish_go-modiff_no_subcommand' -f -l from -s f -r -d 'the start of the comparison, any valid git rev (required)'
...
complete -c go-modiff -n '__fish_go-modiff_no_subcommand' -f -l header-level -s H -r -d 'markdown header level depth'
complete -c go-modiff -n '__fish_go-modiff_no_subcommand' -f -l format -s o -r -d 'output format (markdown or json)'
complete -c go-modiff -n '__fish_go-modiff_no_subcommand' -f -l filter -r -d 'filter output by category (added, changed, or removed)'
complete -c go-modiff -n '__fish_go-modiff_no_subcommand' -f -l concurrency -s c -r -d 'number of concurrent proxy requests for link resolution'
